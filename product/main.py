...
images = ["android", "battery", "cloud", "cross", "dove", "earth", "electricity", "electronics", "fire", "human", "oil", "peace", "tick", "tree", "web", "wheel"]

select = choice(images)

set_on = set()
input_file = open("source/" + select + ".txt")
...
color3Lower = np.array([0,0,200], dtype=np.uint8)
